							...
							<div class="container-fluid">
								...
								<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
									<ul class="nav navbar-nav navbar-right" id="top-nav">
										...
										<li><a href="#about-us">Postres</a></li>
										<li><a href="#blog">Elige tu torta</a></li>
										<li><a href="#price">Personalizados</a></li>
										<li><a href="#subscribe">Eventos</a></li>
										<li><a href="#subscribe">Contacto</a></li>
										<li><a href="php/index.php">Iniciar Sesion</a></li>
				...
				<div class="col-md-12">
					<div class="block wow fadeInUp" data-wow-duration="500ms" data-wow-delay="300ms">
						...
						<div id="owl-example" class="owl-carousel">
							<div>
								<img class="img-responsive" src="assets/images/slider-img-1.jpg" alt="">
							</div>
							<div>
								<img class="img-responsive" src="assets/images/slider-img-2.jpg" alt="">
							</div>
							<div>
								<img class="img-responsive" src="assets/images/slider-img-3.jpg" alt="">
							</div>
							<div>
								<img class="img-responsive" src="assets/images/slider-img-4.jpg" alt="">
							</div>
							<div>
